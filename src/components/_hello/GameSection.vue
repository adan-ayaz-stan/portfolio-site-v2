...
import FourScrews from "./GameSection__Children/FourScrews.vue";
import SnakeGame from "./GameSection__Children/SnakeGame.vue";
...
<template>
  ...
  >
    ...
    <div class="col-span-3 flex flex-col pt-6">
      <div>
        <p class="text-gray-500">// use keyboard</p>
        <p class="text-gray-500">// arrows to play</p>
        ...
        <!-- food left part -->
        <p class="mt-8 text-gray-500">// food left</p>
