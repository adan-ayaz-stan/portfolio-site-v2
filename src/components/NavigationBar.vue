...
<template>
  <ul class="relative hidden lg:flex flex-row text-[#607B96] border-solid border-[#1e2d3d] border-b-[1px]"
    style="font-family: 'Fira Code' monospace">
    <!--  -->
    <div :style="{ width: `${activeBar.width}px`, left: `${activeBar.posY}px` }"
      class="absolute bottom-0 min-w-[0px] h-[2px] bg-[#fea55f] transition-all duration-500 whitespace-nowrap"></div>
    <li @mouseenter="elementHovered" @mouseleave="hoverLeave" id="_user"
    ...
    <li @click="setElementActive('_hello')" @mouseenter="elementHovered" @mouseleave="hoverLeave" id="_hello"
    ...
    <li @click="setElementActive('_about-me')" @mouseenter="elementHovered" @mouseleave="hoverLeave" :style="{
    ...
    <li @click="setElementActive('_projects')" @mouseenter="elementHovered" @mouseleave="hoverLeave" :style="{
    ...
    <li @click="setElementActive('_contact-me')" @mouseenter="elementHovered" @mouseleave="hoverLeave" id="_contact-me"
      :style="{
